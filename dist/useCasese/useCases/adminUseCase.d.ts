...
export declare class AdminUseCase implements IAdminUseCase {
    ...
    constructor(userRepository: IUserRepository, instrctorAgreementRepository: IInstructorAgreementRepository, categoryRepository: ICategoryRepository, notificationRepository: INotificationRepository, cloudSession: ICloudSession);
