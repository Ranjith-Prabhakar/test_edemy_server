...
class AdminUseCase {
    constructor(userRepository, instrctorAgreementRepository, categoryRepository, notificationRepository, cloudSession) {
    ...
    approveOrRejectInstructor(req, next) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const userSession = (yield this.cloudSession.getUser(userId));
                let newUserSession = JSON.parse(userSession);
                newUserSession.role = "instructor";
                yield this.cloudSession.createUserSession(userId, newUserSession);
                console.log("*** newUserSession **", newUserSession);
                console.log("*****", yield this.cloudSession.getUser(userId));
