        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (notificationRepoUpdate) {
                    ...
                    for (let key in StaticClassProperty_1.SocketClass.SocketUsers) {
                        if (key !== req.body.instructorId) {
                            activeUsersExceptInstructor.push(StaticClassProperty_1.SocketClass.SocketUsers[key]);
                        }
                    }
                    ...
                    activeUsersExceptInstructor.forEach((user) => user.emit("fromServerCourseApprovedNotificationForAllUsers", `a new course has been added`));
                }
                return result;
            }
            catch (error) {
